                    ...
                    <div className="flex flex-col gap-12 mt-12 w-full">
                        ...
                        >
                            ...
                            <div className="flex items-center md:items-start gap-5 w-full md:w-auto mt-2 md:mt-0">
                                <div className="flex-shrink-0 w-24 h-24 md:w-28 md:h-28 relative flex items-center justify-center">
                        ...
                        >
                            ...
                            <div className="flex items-center md:items-start gap-5 w-full md:w-auto mt-2 md:mt-0">
                                <div className="flex-shrink-0 w-24 h-24 md:w-28 md:h-28 relative flex items-center justify-center">
                                    <Image src={suezLogo} alt="Suez Eau France Logo" fill className="object-contain" />
                                </div>
                                <div className="flex-1 md:hidden">
